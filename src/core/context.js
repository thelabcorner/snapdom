...
export function createContext(options = {}) {
  ...
  const context = {
    ...
    // Internal R7-SA3 counterfactual. Parent flex/grid classification can consume the exact
    // parent's live declaration already resident in the capture-local style cache; false
    // restores the historical getStyle(parent) acquisition.
