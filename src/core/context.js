...
export function createContext(options = {}) {
  ...
  const context = {
    ...
    // Internal R7-GR1 counterfactual: false preserves addScrollbarGutter's historical live
    // CSSOM reads even when the exact same property is already present in the style snapshot.
